module.exports = function(RED) {
    ...
    function JigsawStackSpamNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            node.status({fill:"yellow", shape:"dot", text:"Checking for spam..."});
            try {
                const result = await jigsawstack.validate.spamcheck(text);
    ...
    RED.nodes.registerType("jigsawstack-spam", JigsawStackSpamNode);
}
