module.exports = function(RED) {
    ...
    function JigsawStackSentimentNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            node.status({fill:"yellow", shape:"dot", text:"Analyzing sentiment..."});
            try {
    ...
    RED.nodes.registerType("jigsawstack-sentiment", JigsawStackSentimentNode);
}
