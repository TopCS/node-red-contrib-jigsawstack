module.exports = function(RED) {
    ...
    function JigsawStackSpellNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            const language_code = msg.payload?.language_code || config.language_code;
            ...
            node.status({fill:"yellow", shape:"dot", text:"Checking spelling..."});
            try {
    ...
    RED.nodes.registerType("jigsawstack-spell", JigsawStackSpellNode);
}
