module.exports = function(RED) {
    ...
    function JigsawStackImageNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            node.status({fill:"yellow", shape:"dot", text:"Generating image..."});
            try {
    ...
    RED.nodes.registerType("jigsawstack-image", JigsawStackImageNode);
}
