module.exports = function(RED) {
    ...
    function JigsawStackObjectDetectionNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            node.status({fill:"yellow", shape:"dot", text:"Detecting objects..."});
            try {
    ...
    RED.nodes.registerType("jigsawstack-object-detection", JigsawStackObjectDetectionNode);
}
