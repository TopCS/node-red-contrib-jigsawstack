module.exports = function(RED) {
    ...
    function JigsawStackTranslateTextNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            const current_language = msg.payload?.current_language || config.current_language;
            ...
            node.status({fill:"yellow", shape:"dot", text:"Translating text..."});
            try {
                const result = await jigsawstack.translate.text({
                    text: text,
    ...
    RED.nodes.registerType("jigsawstack-translate-text", JigsawStackTranslateTextNode);
}
