module.exports = function(RED) {
    ...
    function JigsawStackNsfwNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            node.status({fill:"yellow", shape:"dot", text:"Checking for NSFW content..."});
            try {
                const result = await jigsawstack.validate.nsfw({
                    url: url,
                });
    ...
    RED.nodes.registerType("jigsawstack-nsfw", JigsawStackNsfwNode);
}
